...
<button onclick="replaceYear('2022preEE')">2022preEE</button>
<button onclick="replaceYear('2022postEE')">2022postEE</button>
<button onclick="replaceYear('2023preBPix')">2023preBPix</button>
<button onclick="replaceYear('2023postBPix')">2023postBPix</button>
<script>
